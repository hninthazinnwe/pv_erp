<x-layout>
    <x-content>
        ...
        <div>
        @include('backend.location.create')

        @include('backend.location.edit')
        ...
        <script>
            $(document).ready(function() {
                window.deleteData = function(uuid) {
                    var url = "{{ route('locations.destroy', ':uuid') }}";
                ...
                window.editData = function(uuid) {
                    var editUrl = "{{ route('locations.edit', ':uuid') }}";
                    var updateUrl = "{{ route('locations.update', ':uuid') }}";
